...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Am(e,t,n){let r=new Float32Array(gm),i=new Q(0,1,0);return new lp({name:`SphericalGaussianBlur`,defines:{n:gm,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Nm(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function jm(){return new lp({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Nm(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Mm(){return new lp({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Nm(),fragmentShader:`
	...
	`}var Pm=class extends Nu{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Yf(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;function x_(e){let t=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,n;try{n=new v_({canvas:e,antialias:!1,powerPreference:`high-performance`})}catch{return e.style.background=`radial-gradient(120% 90% at 70% 20%, #1d150d 0%, #0a0a09 60%)`,null}let r=new yd,i=new Lp(-1,1,1,-1,0,1),a={uTime:{value:0},uResolution:{value:new du(1,1)},uMouse:{value:new du(.5,.5)}},o=new lp({vertexShader:y_,fragmentShader:b_,uniforms:a}),s=new Lf(new ep(2,2),o);r.add(s);let c=new du(.5,.5),l=()=>{let{clientWidth:t,clientHeight:r}=e,i=Math.min(window.devicePixelRatio,2);n.setSize(t,r,!1),n.setPixelRatio(i),a.uResolution.value.set(t*i,r*i)},u=e=>{c.set(e.clientX/window.innerWidth,1-e.clientY/window.innerHeight)};if(l(),window.addEventListener(`resize`,l),t)return n.render(r,i),{destroy(){window.removeEventListener(`resize`,l),o.dispose(),s.geometry.dispose(),n.dispose()}};window.addEventListener(`mousemove`,u);let d=0,f=performance.now(),p=()=>{a.uTime.value=(performance.now()-f)/1e3,a.uMouse.value.lerp(c,.04),n.render(r,i),d=requestAnimationFrame(p)};return d=requestAnimationFrame(p),{destroy(){cancelAnimationFrame(d),window.removeEventListener(`resize`,l),window.removeEventListener(`mousemove`,u),o.dispose(),s.geometry.dispose(),n.dispose()}}}pi.registerPlugin(Ms);function S_(e){let t=(e.textContent??``).replace(/\s+/g,` `).trim();if(e.textContent=``,!t)return[];let n=t.split(` `).map(e=>{let t=document.createElement(`span`);return t.style.display=`inline-block`,t.textContent=e,t});n.forEach((t,r)=>{e.appendChild(t),r<n.length-1&&e.appendChild(document.createTextNode(` `))});let r=[],i=null;return n.forEach(e=>{let t=e.offsetTop;(i===null||t!==i)&&(r.push([]),i=t),r[r.length-1].push(e.textContent??``)}),e.textContent=``,r.map(t=>{let n=document.createElement(`span`);n.className=`split-line-mask`;let r=document.createElement(`span`);return r.className=`split-line`,r.textContent=t.join(` `),n.appendChild(r),e.appendChild(n),r})}function C_(e,t=0){return pi.fromTo(e,{yPercent:115},{yPercent:0,duration:1.1,stagger:.09,ease:`power4.out`,delay:t})}function w_(e,t){pi.fromTo(t,{yPercent:115},{yPercent:0,duration:1.1,stagger:.09,ease:`power4.out`,scrollTrigger:{trigger:e,start:`top 85%`,once:!0}})}function T_(){document.querySelectorAll(`[data-reveal]`).forEach((e,t)=>{pi.fromTo(e,{y:48,autoAlpha:0},{y:0,autoAlpha:1,duration:1,ease:`power3.out`,delay:t%4*.08,scrollTrigger:{trigger:e,start:`top 88%`,once:!0}})})}function E_(){let e=document.getElementById(`cursor`);if(!e||window.matchMedia(`(hover: none), (pointer: coarse)`).matches)return;let t=e.querySelector(`.cursor__dot`),n=e.querySelector(`.cursor__ring`);if(!t||!n)return;let r=pi.quickTo(t,`x`,{duration:.12,ease:`power2.out`}),i=pi.quickTo(t,`y`,{duration:.12,ease:`power2.out`}),a=pi.quickTo(n,`x`,{duration:.45,ease:`power3.out`}),o=pi.quickTo(n,`y`,{duration:.45,ease:`power3.out`});window.addEventListener(`mousemove`,e=>{r(e.clientX),i(e.clientY),a(e.clientX),o(e.clientY)}),document.querySelectorAll(`[data-cursor], a, button`).forEach(t=>{t.addEventListener(`mouseenter`,()=>e.classList.add(`is-hover`)),t.addEventListener(`mouseleave`,()=>e.classList.remove(`is-hover`))})}function D_(){window.matchMedia(`(hover: none), (pointer: coarse)`).matches||document.querySelectorAll(`[data-magnetic]`).forEach(e=>{let t=pi.quickTo(e,`x`,{duration:.4,ease:`power3.out`}),n=pi.quickTo(e,`y`,{duration:.4,ease:`power3.out`});e.addEventListener(`mousemove`,r=>{let i=e.getBoundingClientRect();t((r.clientX-(i.left+i.width/2))*.3),n((r.clientY-(i.top+i.height/2))*.3)}),e.addEventListener(`mouseleave`,()=>{pi.to(e,{x:0,y:0,duration:.7,ease:`elastic.out(1, 0.4)`})})})}function O_(){let e=document.getElementById(`nav`);if(!e)return;let t=()=>e.classList.toggle(`is-scrolled`,window.scrollY>40);window.addEventListener(`scroll`,t,{passive:!0}),t()}function k_(e){let t=document.getElementById(`preloader`),n=document.getElementById(`preloader-counter`);if(!t||!n){e();return}if(window.matchMedia(`(prefers-reduced-motion: reduce)`).matches){t.remove(),e();return}let r={value:0};pi.timeline({onComplete:()=>{t.remove()}}).to(r,{value:100,duration:1.5,ease:`power2.inOut`,onUpdate:()=>{n.textContent=String(Math.round(r.value))}}).to(t,{yPercent:-100,duration:.9,ease:`power4.inOut`,onStart:e}).to(`.preloader__inner`,{autoAlpha:0,duration:.4,ease:`power2.in`},`<`)}pi.registerPlugin(Ms);var A_=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches;if(cc(sc()),!A_){let e=new nc({lerp:.1,anchors:!0});e.on(`scroll`,Ms.update),pi.ticker.add(t=>e.raf(t*1e3)),pi.ticker.lagSmoothing(0)}var j_=document.getElementById(`webgl-canvas`);j_&&x_(j_);var M_=Array.from(document.querySelectorAll(`.hero [data-split]`)),N_=Array.from(document.querySelectorAll(`[data-split]`)).filter(e=>!M_.includes(e)),P_=[];function F_(e){P_=M_.flatMap(e=>S_(e)),N_.forEach(t=>{let n=S_(t);e&&w_(t,n)}),e||pi.set(P_,{yPercent:0}),Ms.refresh()}function I_(){if(A_){pi.set(P_,{yPercent:0}),pi.set([`.hero__sub`,`.hero__cta`,`.hero__scroll`,`.nav`],{autoAlpha:1});return}pi.set([`.hero__sub`,`.hero__cta`,`.hero__scroll`],{autoAlpha:0,y:24}),pi.set(`.nav`,{autoAlpha:0,y:-16}),C_(P_,.1),pi.to([`.hero__sub`,`.hero__cta`],{autoAlpha:1,y:0,duration:1,stagger:.12,ease:`power3.out`,delay:.55}),pi.to(`.hero__scroll`,{autoAlpha:1,y:0,duration:1,ease:`power3.out`,delay:1}),pi.to(`.nav`,{autoAlpha:1,y:0,duration:1,ease:`power3.out`,delay:.8})}A_?(F_(!1),k_(I_)):(F_(!0),pi.set(P_,{yPercent:115}),T_(),k_(I_)),document.querySelectorAll(`[data-lang]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.lang;cc(t),Ms.getAll().forEach(e=>e.kill()),F_(!1),N_.forEach(e=>{pi.set(e.querySelectorAll(`.split-line`),{yPercent:0})}),pi.set(`[data-reveal]`,{y:0,autoAlpha:1,clearProps:`transform,opacity,visibility`})})}),E_(),D_(),O_(),mc(),fc(),document.getElementById(`calendly-link`);